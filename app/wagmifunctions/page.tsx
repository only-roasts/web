...
//   const getExpectedSwapAmount = async (
//     tokenIn: string,
//     tokenOut: string,
//     amountIn: string
//   ) => {
...
//       {/* Send Native Token */}
//       <button
//         onClick={() => sendBaseToken("0xRecipientAddress", "0.001")}
...
//       <button
//         onClick={() =>
//           transferERC20("0xTokenAddress", "0xRecipientAddress", "10")
//         }
//         style={{ margin: "5px", padding: "10px" }}
//       >
//         Transfer ERC20
...
//       <button
//         onClick={() =>
//           approveERC20("0xTokenAddress", "0xSpenderAddress", "100")
//         }
//         style={{ margin: "5px", padding: "10px" }}
//       >
//         Approve ERC20
...
//       {/* Swap Tokens */}
//       <button
//         onClick={() => swapTokens("0xTokenIn", "0xTokenOut", "10", "9")}
//         style={{ margin: "5px", padding: "10px" }}
//       >
//         Swap Tokens
//       </button>
...
//       {/* Get ERC20 Balance */}
//       <button
//         onClick={() => getERC20Balance("0xTokenAddress", "0xUserAddress")}
//         style={{ margin: "5px", padding: "10px" }}
//       >
//         Get ERC20 Balance
//       </button>
//       <p>
//         ERC20 Balance:{" "}
//         {erc20Balance !== null ? `${erc20Balance} Tokens` : "N/A"}
//       </p>
...
//         {swapEstimate !== null ? `${swapEstimate} Tokens` : "N/A"}
//       </p>
//     </div>
//   );
// }
